...
export class CoScientistAgent {
    ...
    async generateHypothesis(params) {
        ...
        const hypothesis = this.structuredHypothesisGeneration(params.researchQuestion, params.context, params.domain);
    ...
    structuredHypothesisGeneration(question, context, domain) {
